...
const file_api_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x14api/proto/user.proto\x12\abalance\"0\n" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId2\x86\x01\n" +
	"\vUserService\x12?\n" +
	"\bRegister\x12\x18.balance.RegisterRequest\x1a\x19.balance.RegisterResponse\x126\n" +
	"\x05Login\x12\x15.balance.LoginRequest\x1a\x16.balance.LoginResponseB\x18Z\x16crypto_exchange/api/pbb\x06proto3"
...
var file_api_proto_user_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: balance.RegisterRequest
	(*RegisterResponse)(nil), // 1: balance.RegisterResponse
	(*LoginRequest)(nil),     // 2: balance.LoginRequest
	(*LoginResponse)(nil),    // 3: balance.LoginResponse
}
var file_api_proto_user_proto_depIdxs = []int32{
	0, // 0: balance.UserService.Register:input_type -> balance.RegisterRequest
	2, // 1: balance.UserService.Login:input_type -> balance.LoginRequest
	1, // 2: balance.UserService.Register:output_type -> balance.RegisterResponse
	3, // 3: balance.UserService.Login:output_type -> balance.LoginResponse
